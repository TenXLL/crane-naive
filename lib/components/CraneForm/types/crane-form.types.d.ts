...
export declare type CraneSchemaType = 'number' | 'integer' | 'string' | 'boolean' | 'object' | 'array';
export declare type CraneSchemaEnumType = CraneSchemaEnum | number | string | boolean;
